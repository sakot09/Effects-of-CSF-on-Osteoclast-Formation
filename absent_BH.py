...
result_absent = basinhopping(ssr, initial, minimizer_kwargs= {"args":(x, y_ost_abs_scaled, y_nuc_abs_scaled, y_f6_abs_scaled)})
...
with open("results_BH_absent.txt", "w") as f:
...
plt.tight_layout()
plt.savefig("plot_BH_absent.png")
