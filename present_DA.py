...
result_csf = dual_annealing(ssr, bounds, args=(x, y_ost_pre_scaled, y_nuc_pre_scaled, y_f6_pre_scaled))
...
with open("results_DA_present.txt", "w") as f:
...
plt.tight_layout()
plt.savefig("plot_DA_present.png")
